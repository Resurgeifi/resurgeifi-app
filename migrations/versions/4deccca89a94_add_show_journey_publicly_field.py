...
def upgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('resurgitag_locked', sa.Boolean(), nullable=True))
        batch_op.add_column(sa.Column('show_journey_publicly', sa.Boolean(), nullable=True))

    # Manual type conversion for existing string → JSON
...
def downgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.drop_column('resurgitag_locked')
